...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/remixicon/fonts/remixicon.cs') }}s">
</head>
        ...
        <div class="iq-sidebar sidebar-default">
            <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
                <a href="/" class="header-logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" fill="#656bcc"
                    ...
                    <h5 class="logo-title light-logo ml-3">Inventory Management</h5>
                </a>
                            ...
                            <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class="">
                                    <a href="/barang">
                                        ...
                                        </svg><span class="ml-3">Daftar Nama Barang</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="/daftar">
                                        ...
                                        </svg><span class="ml-3">Daftar Barang</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <li class="">
                                        <a href="../backend/page-list-customers.html">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                                                ...
                                                <path fill-rule="evenodd"
                                                    d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                                            </svg><span class="ml-3">My Account</span>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="/user">
            ...
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                        ...
                        <a href="/" class="header-logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" fill="#FF7E41"
                                class="bi bi-buildings" viewBox="0 0 16 16">
                                <path
                                    d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z" />
                                <path
                            ...
                            <h5 class="logo-title ml-3">Inventory Management</h5>
                        </a>
                    </div>
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center mt-3">
                                                        ...
                                                        <form action="logout" method="post">
                                                            @csrf
                                                            <input type="submit" class="btn border" value="Logout">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
